...
# Cross-compile every package for each published target without cgo. Building
# ./... rather than ./cmd/enclave keeps the windows targets a portability guard
# for the whole tree, even though the published windows binary is only the WSL
# launcher.
